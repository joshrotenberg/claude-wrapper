...
- *(history)* Anchor decoded_path on filesystem for hyphenated slugs (closes #607) (#622)
- *(history)* Anchor decoded_path on filesystem for hyphenated slugs (closes #607) (#625)

### 📚 Documentation

- *(duplex)* Document upstream permission handler limitation (#626)

### ⚙️ Miscellaneous Tasks

- Start work on #607 (#623)
- Release v0.11.0 (#624)
## [0.10.1] - 2026-05-30
