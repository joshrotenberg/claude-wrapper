...
pub fn builtin_skills() -> Vec<Skill> {
    vec![
        ...
        Skill {
            ...
            argument_hint: Some("<code|diff|file|PR>".into()),
        },
        Skill {
            name: "implement".into(),
            ...
            config: None,
            scope: SkillScope::Task,
            argument_hint: Some("<description|issue-url>".into()),
        },
        Skill {
            ...
            config: None,
            scope: SkillScope::Task,
            argument_hint: Some("<file|module|code>".into()),
        },
        Skill {
            name: "refactor".into(),
            ...
            config: None,
            scope: SkillScope::Task,
            argument_hint: Some("<target> <goal>".into()),
        },
        Skill {
            name: "summarize".into(),
            ...
            config: None,
            scope: SkillScope::Task,
            argument_hint: Some("<path|file|content>".into()),
        },
        Skill {
            name: "pre_push".into(),
        ...
        Skill {
            ...
            config: None,
            scope: SkillScope::Task,
            argument_hint: Some("<title> <body> [issue]".into()),
        },
        ...
        Skill {
            ...
            config: None,
            scope: SkillScope::Coordinator,
            argument_hint: Some("<owner/repo> [filters] [--verbose]".into()),
        },
        Skill {
        ...
        Skill {
            ...
            config: None,
            scope: SkillScope::Coordinator,
            argument_hint: Some("[chain-id,chain-id,...]".into()),
        },
        Skill {
            ...
            argument_hint: Some("<task-description>".into()),
        },
    ]
}
